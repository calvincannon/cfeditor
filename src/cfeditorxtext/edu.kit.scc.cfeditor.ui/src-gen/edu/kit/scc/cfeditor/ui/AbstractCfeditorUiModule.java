...
/**
 * Manual modifications go to {edu.kit.scc.cfeditor.ui.CfeditorUiModule}
 */
...
public abstract class AbstractCfeditorUiModule extends DefaultUiModule {
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(edu.kit.scc.cfeditor.parser.antlr.internal.InternalCfeditorLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return edu.kit.scc.cfeditor.ui.contentassist.antlr.CfeditorParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(edu.kit.scc.cfeditor.ui.contentassist.antlr.internal.InternalCfeditorLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(edu.kit.scc.cfeditor.ui.contentassist.antlr.internal.InternalCfeditorLexer.class));
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.CONTENT_ASSIST)).to(edu.kit.scc.cfeditor.ui.contentassist.antlr.internal.InternalCfeditorLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.wizard.IProjectCreator> bindIProjectCreator() {
		return edu.kit.scc.cfeditor.ui.wizard.CfeditorProjectCreator.class;
	}
