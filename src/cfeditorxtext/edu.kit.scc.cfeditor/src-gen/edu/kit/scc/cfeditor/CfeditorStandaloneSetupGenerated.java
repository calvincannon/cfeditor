...
public class CfeditorStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.kit.edu/scc/cfeditor/Cfeditor")) {
		EPackage.Registry.INSTANCE.put("http://www.kit.edu/scc/cfeditor/Cfeditor", edu.kit.scc.cfeditor.cfeditor.CfeditorPackage.eINSTANCE);
	}
