...
import edu.kit.scc.cfeditor.cfeditor.CfeditorFactory;
import edu.kit.scc.cfeditor.cfeditor.CfeditorPackage;
import edu.kit.scc.cfeditor.cfeditor.Part;
...
public class CfeditorPackageImpl extends EPackageImpl implements CfeditorPackage
{
   ...
   * @see edu.kit.scc.cfeditor.cfeditor.CfeditorPackage#eNS_URI
   * @see #init()
   * @generated
   */
