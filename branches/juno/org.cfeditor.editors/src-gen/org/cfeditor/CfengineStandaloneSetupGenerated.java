...
public class CfengineStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.cfeditor.CfengineRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.cfeditor.org/Cfengine")) {
		EPackage.Registry.INSTANCE.put("http://www.cfeditor.org/Cfengine", org.cfeditor.cfengine.CfenginePackage.eINSTANCE);
	}
