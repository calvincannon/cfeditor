...
public class CfeditorStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/xtext/Cfeditor")) {
		EPackage.Registry.INSTANCE.put("http://www.eclipse.org/xtext/Cfeditor", org.eclipse.xtext.cfeditor.CfeditorPackage.eINSTANCE);
	}
